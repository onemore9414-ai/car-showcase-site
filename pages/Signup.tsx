        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl ring-1 ring-black/5">
          ...
          <div className="mb-8 text-center">
             <h2 className="text-3xl font-light tracking-tight text-white font-serif">
               {verificationStep ? 'Verify Your Identity' : 'Join the Elite'}
             </h2>
             <p className="mt-2 text-sm text-gray-400">
               {verificationStep 
                  ? `We've sent a verification code to ${email}. Check your console logs for the mock code.`
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {!verificationStep ? (
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-right-8 duration-500">
                <div className="group relative">
                  <label className="mb-1 block text-xs font-bold uppercase tracking-widest text-gray-500 group-focus-within:text-indigo-400">Verification Code</label>
                  <div className="relative">
                     <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-gray-500 group-focus-within:text-white">
                     ...
                     <input
                       ...
                       className="block w-full rounded-xl border border-white/10 bg-white/5 py-3.5 pl-12 pr-4 text-white text-center text-lg tracking-[0.5em] font-mono placeholder:text-gray-600 focus:border-indigo-500 focus:bg-white/10 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm transition-all"
                       placeholder="000000"
                       autoFocus
                     />
                  </div>
            ...
            <div className="pt-2">
              ...
              >
                ...
                {isSubmitting ? (
                    ...
                    {verificationStep ? 'Verifying...' : 'Processing...'}
                    </>
                ) : (
                    <>
                    {verificationStep ? 'Complete Verification' : 'Create Account'} 
          ...
          <div className="mt-8 text-center">
             <p className="text-sm text-gray-500">
               {verificationStep ? (
                  <button onClick={() => setVerificationStep(false)} className="font-semibold text-white hover:text-indigo-400 hover:underline">Back to Details</button>
               ) : (
