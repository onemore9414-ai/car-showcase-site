...
import { ArrowRight, Loader2, AlertCircle, Mail, Lock, Globe } from 'lucide-react';
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl ring-1 ring-black/5">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-sm text-gray-400">
              Sign in to access your garage and configuration.
            </p>
          </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-wider">
                <span className="bg-transparent px-4 text-gray-500">New to Brand?</span>
              </div>
            </div>
